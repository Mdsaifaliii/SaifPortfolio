  ...
  return (
    <section
      ...
      style={{
        ...
        backgroundAttachment: window.innerWidth > 768 ? "fixed" : "scroll", // Parallax effect for larger screens
      }}
    >
      {/* Gradient Overlay */}
      ...
      <p
        ...
        >
          <span
            className="text-transparent bg-clip-text bg-gradient-to-r from-teal-500 via-blue-500 to-purple-500"
          >
            Hi, 
          </span>{" "}
          <span
            className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 via-blue-500 to-teal-500"
          >
            Mohd Saif Ali
          </span>
        </h1>
